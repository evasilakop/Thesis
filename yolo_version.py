...
if __name__ == '__main__':
    ...
    ap.add_argument("-c", "--confidence", type=float, default=0.5, help=
                    "Minimum probability to filter weak detections, format: 0.X")
    ap.add_argument("-f", "--frequency", required=False, type=float, default=3, 
    ...
    max_index = dist_matrix.argmax(axis=0)
    # returns the row where the maximum is detected, odd or 
